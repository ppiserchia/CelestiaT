...
//        stars: [
//            StarModel(
//                 starPrompt: Prompt(PromptName: localizedString("coming_out")),
...
//            
//            StarModel(
//                 starPrompt: Prompt(PromptName: localizedString("gender_identity")),
//                 user: "Creative Beaver",
...
//            
//            StarModel(
//                 starPrompt: Prompt(PromptName: localizedString("media_representation")),
//                 user: "Creative Beaver",
