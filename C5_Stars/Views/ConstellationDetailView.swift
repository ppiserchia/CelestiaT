...
struct ConstellationDetailView: View {
    ...
    var stars: [StarModel]
//    var constellationDetailViewStarPromt: Prompt
//    var constellationDetailViewStarStory: String
...
//                PromptStoryView(promptName: constellationDetailViewStarPromt, promptStory: constellationDetailViewStarStory)
...
//            constellationDetailViewStarPromt: Prompt(PromptName: "Coming out"),
//            constellationDetailViewStarStory: "Lore ipsum dolor sit amet, consectetur adipiscing elit. Nullam auctor quam id massa faucibus dignissim. Nullam eget metus id nisl malesuada condimentum. Nam viverra fringilla erat, ut fermentum nunc feugiat eu.")
        ConstellationDetailView(
            constellationDetailViewTitle: "Creative Beaver",
            stars: [
                StarModel(
